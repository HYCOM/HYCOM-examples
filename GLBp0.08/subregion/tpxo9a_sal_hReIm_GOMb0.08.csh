...
#
/bin/rm -f ${DT}/tpxo9a_sal_hReIm_GLBp.a
/bin/rm -f ${DT}/tpxo9a_sal_hReIm_GLBp.b
~/HYCOM-tools/subregion/src/isuba_field <<E-o-D
../../${RT}/topo/regional.gmapi_${RO}.a
NONE
NONE
${DO}/tpxo9a_sal_hReIm.a
${DT}/tpxo9a_sal_hReIm_GLBp.a
  ...
  19      'kskip ' = number of characters before min,max in .b files
E-o-D
date
