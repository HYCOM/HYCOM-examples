...
foreach P ( 03 04 05 06 07 08 09 10 11 12 )
#   no leading expt number for nesting files
    touch   ${N}/archm.1994_${P}_2015_${P}.b
    /bin/rm ${N}/archm.1994_${P}_2015_${P}.[ab]
    /usr/bin/time ${BINRUN} ${TOOLS}/subregion/src/isubaregion <<E-o-D
${TU}/regional.grid.a
${TU}/regional.gmapi_${R}.a
${TU}/depth_${U}_${VU}.a
regional.depth.a
${D}/53X_archMN.1994_${P}_2015_${P}.a
${N}/archm.1994_${P}_2015_${P}.a
${R} interpolated to ${U}
...
E-o-D
    ...
    touch  ${N}/archm.1994_${P}_2015_${P}.b
    if (-z ${N}/archm.1994_${P}_2015_${P}.b) then
      echo "missing archive file: " ${N}/archm.1994_${P}_2015_${P}.b
      exit (2)
    endif
