...
if (-z regional.depth.a) then
  ...
  /bin/ln -s ${DS}/topo/depth_GOMb0.08_07.a regional.depth.a
endif
if (-z regional.depth.b) then
  /bin/rm regional.depth.b
  /bin/ln -s ${DS}/topo/depth_GOMb0.08_07.b regional.depth.b
endif
#
...
setenv O ${DS}/relax/SSH
mkdir -p ${O}/relax/SSH
#
foreach y ( 1994 )
    setenv FOR021A ${O}/relax_montg_${E}_1994.a
    setenv FOR021  ${O}/relax_montg_${E}_1994.b
    /bin/rm $FOR021
    /bin/rm $FOR021A
