...
C --- 01.0 - No winds, 1 day run for template restart, from WOA13 climatology
...
if   ($XM != "") then
  ...
  if (-z relax.montg.a) then
     ${pget} ${DS}/relax/SSH/relax_montg_${XM}_1994-1998.a relax.montg.a &
  endif
  touch  relax.montg.b
  if (-z relax.montg.b) then
     ${pget} ${DS}/relax/SSH/relax_montg_${XM}_1994-1998.b relax.montg.b &
  endif
endif
C
setenv XR "_150_07"
