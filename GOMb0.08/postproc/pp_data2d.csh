...
if (${ARCHIVE} == 1) then
  /usr/bin/rcp  ${A}/${E}_archm.${YY}${P}_${f}.tar.gz newton:/u/home/${user}/hycom/${R}/expt_${X}/data/data2d &
endif
end
foreach f (ssh sst uv1 vv1)
...
#                      cut range depends on username
  ...
  ${BINRUN} hycom_profile_list $f 127 $HOME/hycom/${R}/mooring_all.txt ${ff}_NAME
end
#
foreach f (PCM-1 INSTANT PIRATA TAO INDIAN PhilEx)
  ${BINRUN} /bin/tar cvf ${A}/${E}_archm.${YY}${P}_${f}_moorings.tar ${E}*${f}*txt
if (${ARCHIVE} == 1) then
  /usr/bin/rcp ${A}/${E}_archm.${YY}${P}_${f}_moorings.tar newton:/u/home/${user}/hycom/${R}/expt_${X}/data/profiles &
endif
