...
cd $S/tars_${Y01}${A}
C
${BINRUN} /usr/bin/rcp ${E}_archs_${Y01}${A}1.tar.gz newton:${DN} &
${BINRUN} /usr/bin/rcp ${E}_archs_${Y01}${A}2.tar.gz newton:${DN} &
${BINRUN} /usr/bin/rcp ${E}_archs_${Y01}${A}3.tar.gz newton:${DN} &
${BINRUN} /usr/bin/rcp ${E}_archs_${Y01}${A}4.tar.gz newton:${DN} &
wait
