...
if (-z tidal.rh.a) then
   ${pget} ${DS}/relax/DRAG/tidal.JSLH.${T}${TT}.a tidal.rh.a  &
endif
if (-z tidal.rh.b) then
   ${pget} ${DS}/relax/DRAG/tidal.JSLH.${T}${TT}.b tidal.rh.b  &
endif

#setenv SRI ""
setenv SRI "tpxo9a_sal"
if ($SRI != "") then
  touch  tidal.salReIm.a
  if (-z tidal.salReIm.a) then
     ${pget} ${DS}/relax/SAL/${SRI}_ReIm_${T}.a tidal.salReIm.a  &
  endif
  touch  tidal.salReIm.b
  if (-z tidal.salReIm.b) then
     ${pget} ${DS}/relax/SAL/${SRI}_ReIm_${T}.b tidal.salReIm.b  &
  endif
endif
C
C --- restart input
