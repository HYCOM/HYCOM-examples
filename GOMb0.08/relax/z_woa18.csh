...
set time = 1
C
C --- Script to horizontally interpolate NetCDF World Ocean Atlas 18 fields
C --- onto HYCOM grid. For vertical interpolation, see relax.csh
C --- See z_woa18.f in HYCOM-tools/relax/src for interp. options.
C
...
C --- L is WOA18 raw file  directory
C
setenv P   ${DS}/relax/WOA18
setenv S   ${P}/SCRATCH
setenv L   ${DSR}/WOA18
C
mkdir -p $S
...
C
ln -s  $L/WOA18_PTEMP_m${MM}.nc tm${MM}.nc  &
ln -s  $L/WOA18_SALT_m${MM}.nc sm${MM}.nc  &
C
