...
/bin/rm -f fort.[5]1*
ln -s depth_GOMb0.08_07.b  fort.51
ln -s depth_GOMb0.08_07.a  fort.51A
#if (-e landsea_GOMb0.08.a) then
#  /bin/rm -f regional.mask.a
#  /bin/ln -s landsea_GOMb0.08.a regional.mask.a
#endif
# --- 09m11 land/sea mask
if (-e landsea_GOMb0.08_09m11s.a) then
  /bin/rm -f regional.mask.a
  /bin/ln -s landsea_GOMb0.08_09m11s.a regional.mask.a
endif
