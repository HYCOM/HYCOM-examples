...
mlist ${Y01} ${YXX} 1 ${MM}
cp LIST LIST++
setenv day1 `echo "LIMITS" | awk -f ${N}.awk y01=${Y01} ab=${MM} | awk '{print $1}'`
setenv day2 `echo "LIMITS" | awk -f ${N}.awk y01=${Y01} ab=${MM} | awk '{print $2}'`
#setenv restart -  ## - means no restart (+ means restart)
setenv restart +  ## - means no restart (+ means restart)
cat >! ${N}y${Y01}${MM}.limits <<EOF
${restart}${day1}  ${day2}
EOF
