...
if   ($XM != "") then
  ...
  if (-z relax.montg.a) then
     ${pget} ${DS}/relax/SSH/relax_montg_${XM}_2017-2020.a relax.montg.a &
  endif
  touch  relax.montg.b
  if (-z relax.montg.b) then
     ${pget} ${DS}/relax/SSH/relax_montg_${XM}_2017-2020.b relax.montg.b &
  endif
endif
C
setenv XR "_m0p5psu"
...
#  endif
  touch  archm_${Y01}${A}_espc.tar.gz
  if (-z archm_${Y01}${A}_espc.tar.gz) then
    ${pget} ${DS}/nest/archm_${Y01}${A}_espc.tar.gz archm_${Y01}${A}_espc.tar.gz
  endif
  tar xzvf archm_${Y01}${A}_espc.tar.gz
  cd ..
endif
C
...
if (-e ./nest) then
  if (! -e ./nest/nest.tar) then
    cd ./nest
    touch  archm_${Y01}${B}_espc.tar.gz
    if (-z archm_${Y01}${B}_espc.tar.gz) then
      ${pget} ${DS}/nest/archm_${Y01}${B}_espc.tar.gz archm_${Y01}${B}_espc.tar.gz
    endif
    cd ..
  endif
endif
