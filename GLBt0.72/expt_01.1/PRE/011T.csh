...
# --- awk -f 284.awk y01=098 ab=a 284T.csh > 284t098a.csh
C
...
if (-e ../cice) then
  ...
  cd ../cice
# incoming Qlw from netQlw and Tsur, just calculate surtmp4 in Kelvin here
  /bin/rm surtmp4_${Y01}${A}.a
  ${BINRUN} ~/HYCOM-tools/bin/hycom_expr ../ssta/surtmp_${Y01}${A}.a SQSQ ${IDM} ${JDM} 1.0 273.15 surtmp4_${Y01}${A}.a >! surtmp4_${Y01}${A}.b
endif
C
C  --- END OF JUST IN TIME SURTMP EXTRACTION SCRIPT.
C
date +"END    %c"
#
