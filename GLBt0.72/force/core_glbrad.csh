...
set time = 1
C
C --- Script to horizontally interpolate NetCDF CORE2 NYF shortwave down forcing to
...
C
setenv CDF071 $L/ncar_rad.15JUNE2009.nc
C
C
...
./kp_core <<'E-o-D'
 ...
 &AFTIME
  ...
  PAROFF =    0.0,   !none
  FSTART = 1096.5,   !Jan 01, climo
  WSTART = 1096.5,   !Jan 01, climo
  TSTART =    0.5,   !Jan 01, climo
  TMAX   =  364.5,   !Dec 31, climo
 &END
 &AFFLAG
...
C --- 6-hrly Output
C
/bin/mv fort.10  ./glbrad.b
/bin/mv fort.10A ./glbrad.a
C
#${pput} glbrad.b ${D}/glbrad.b
#${pput} glbrad.a ${D}/glbrad.a
C
C --- Delete all files.
C
