...
cd ../PRE
foreach t ( preA.csh preB.csh F.csh G.csh L.csh P.csh T.csh W.csh V.csh )
...
## --- newton is the archive machine at Navy DSRC
##
...
##
#ssh newton ln -s "010" /u/home/${user}/${DN}/../relax/$N
