...
set timestamp
C
C --- Experiment GLBt0.72 - 01.0 series
C --- 41 layer sig2star HYCOM for fully global region.
C --- 01.0 - CORE2 NY repeating forced, L+Y U10 bulk parameterization.
C ---        No offlux, chl turbidity.
C ---        17-term equation of state, 2.3.0
C ---        Initialize from Jan WOA13 and use WOA13 for SSS relaxation.
C ---        spatially varying SSS relaxation,i.e. 4 years everywhere 
C ---        except 6 mon in Southern Ocean,
C ---        depth_GLBt0.72_15.
C --- 01.1 - Twin of 01.0 for on-the-fly created CORE2 forcing yrflag=3
C --- 01.2 - Twin of 01.1 for HYCOM src_2.3.01 
C
...
if (-z forcing.rivers.a) then
   ${pget} ${DS}/force/rivers/runoff.daitren.clim.a forcing.rivers.a &
endif
if (-z forcing.rivers.b) then
   ${pget} ${DS}/force/rivers/runoff.daitren.clim.b forcing.rivers.b &
endif
C
touch  forcing.chl.a
touch  forcing.chl.b
...
###  touch  relax.sssrmx.a
###  if (-z relax.sssrmx.a) then
###     ${pget} ${DS}/relax/SSSRMX/sssrmx.a relax.sssrmx.a &
###  endif
###  touch  relax.sssrmx.b
###  if (-z relax.sssrmx.b) then
###     ${pget} ${DS}/relax/SSSRMX/sssrmx.b relax.sssrmx.b &
###  endif
endif
setenv XR "019"
if ($XR != "") then
  ...
  if (-z relax.montg.a) then
     ${pget} ${DS}/relax/SSH/relax_montg_${XR}.a relax.montg.a &
  endif
  touch  relax.montg.b
  if (-z relax.montg.b) then
     ${pget} ${DS}/relax/SSH/relax_montg_${XR}.b relax.montg.b &
  endif
endif
setenv XR "sp"
if ($XR != "") then
  ...
  if (-z relax.sefold.a) then
     ${pget} ${DS}/relax/${E}/sefold_${XR}.a relax.sefold.a &
  endif
  touch  relax.sefold.b
  if (-z relax.sefold.b) then
     ${pget} ${DS}/relax/${E}/sefold_${XR}.b relax.sefold.b &
  endif
endif
#  touch  relax.sstrlx.a
#  if (-z relax.sstrlx.a) then
#     ${pget} ${DS}/relax/${E}/sstrlx_${XR}.a relax.sstrlx.a &
#  endif
#  touch  relax.sstrlx.b
#  if (-z relax.sstrlx.b) then
#     ${pget} ${DS}/relax/${E}/sstrlx_${XR}.b relax.sstrlx.b &
#  endif
...
if (-e ./nest) then
  ...
  if (-z archv_${Y01}${A}.tar) then
    ${pget} ${DS}/nest/archv_${Y01}${A}.tar archv_${Y01}${A}.tar
  endif
